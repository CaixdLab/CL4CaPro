...
We trained models on two RTX 4090/16GB GPU cards with 8 threads. To optimize the speed, the number of threads may need to be adjusted according to the GPUs.  
