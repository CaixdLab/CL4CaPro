...
CPTAC-3 RNA-seq and clinical datasets can be downloaded from [GDC data portal](https://portal.gdc.cancer.gov/projects/CPTAC-3).  CPTAC-3 datasets were used to validate the lung cancer models trained with TCGA data. </li>
  <li>DKFZ prostate dataset 
  
DKFZ RNA-seq and cinical datasets can be downloaded from [cBioPortal](https://www.cbioportal.org/). DKFZ datasets were used to validate prostate cancer models trained with TCGA data.  </li>
...
The datasets can be downloaded from the the [site](https://filetransfer.abbvie.com/w/f-0572ba21-9252-48e3-b8ac-ad36ab1c4feb) provided by the first authour or our [OneDrive](https://miamiedu-my.sharepoint.com/:f:/r/personal/x_cai_miami_edu/Documents/CaixdLab/CL4CaPro?csf=1&web=1&e=OGT77f)
  <li>
