...
def main():
    ...
    if opt_get.cancer_group == 'BRCA' and opt_get.validation == 'Affy':
        #TotalCancerDataPath = './DataSet/CancerRNA_AffyBRCA_' + opt_get.task + '_' + str(
        #    opt_get.split_class_num) + '_DMFS.txt'
        TotalCancerDataPath = './DataSet/CancerRNA_AffyBRCAOncotypeDX_' + opt_get.task + '_' + str(
            opt_get.split_class_num) + '_DMFS.txt'
    else:
        TotalCancerDataPath = './DataSet/CancerRNA_' + opt_get.cancer_group + '_' + opt_get.task + '_' + str(opt_get.split_class_num) + '.txt'
    ...
    opt_get.model_save_path = '{}_{}_{}'.format(opt_get.model_save_path, opt_get.cancer_group, seed)
    #opt_get.model_save_path = opt_get.model_save_path + '_' + str(opt_get.seed)

    if not os.path.exists('./save/' + opt_get.model_save_path + '/Features'):
        os.mkdir('./save/' + opt_get.model_save_path + '/Features')
        ...
        for j in range(len(dim_2_list)):
            for k in range(len(dim_3_list)):
                for lr in learning_rate_list:
                    ...
                    model_path = './save/{}/CancerRNA_models/CLCP_{}_{}_{}_feat_{}_lr_{}_l2_{}_cl_{}_seed_{}_round_{}_decay_0.0001_bsz_{}_temp_0.07/'.\
                    ...
                    save_path = './save/' + opt_get.model_save_path + '/Features/' + title + '_' + opt_get.layer_name + '.txt'
